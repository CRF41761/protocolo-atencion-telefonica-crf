...
// DICCIONARIO: Mapeo de nombres en inglés (MobileNet) a español
// IMPORTANTE: Las claves más largas deben ir ANTES para evitar falsos positivos
const diccionarioEspecies = {
  ...
  "albatross": "Albatros",
  "great albatross": "Albatros",
  "wandering albatross": "Albatros errante",
  "petrel": "Pardela",
  "shearwater": "Pardela",
  "storm petrel": "Paíño",
  "fulmar": "Fulmar",
  ...
  "moorhen": "Gallineta",
  "grebe": "Zampullín",
  "great crested grebe": "Somormujo",
  "little grebe": "Zampullín común",

  // Aves - Gaviotas, charranes y similares
  "gull": "Gaviota",
  "herring gull": "Gaviota patiamarilla",
  ...
  "scaup": "Porrón bastardo",
  "goosander": "Mergo grande",
  "smew": "Mergo chico",
  "red-breasted merganser": "Mergo serrado",
  "swan": "Cisne",
  "mute swan": "Cisne vulgar",
  "black swan": "Cisne negro",
  "goose": "Oca",
  "greylag goose": "Ánsar común",
  "barnacle goose": "Barnacla",
  ...
  // Pájaros pequeños y passeriformes
  "hummingbird": "Colibrí",
  ...
  "fan-tailed warbler": "Zarcero común",
  ...
  "nuthatch": "Trepador",
  "european nuthatch": "Trepador azul",
  "creeper": "Agateador",
  "short-toed treecreeper": "Agateador común",
  "blue tit": "Herrerillo común",
  "great tit": "Carbonero común",
  "coal tit": "Carbonero garrapinos",
  "crested tit": "Carbonero crestado",
  "long-tailed tit": "Mito",
  "penduline tit": "Pájaro moscón",
  "bearded reedling": "Bigotudo",
  "jay": "Arrendajo",
  "eurasian jay": "Arrendajo",
  "magpie": "Urraca",
  "eurasian magpie": "Urraca",
  "jackdaw": "Grajilla",
  "rook": "Grajo",
  "carrion crow": "Corneja negra",
  "hooded crow": "Corneja cenicienta",
  "crow": "Cuervo",
  "raven": "Cuervo",
  "common raven": "Cuervo",
  "chough": "Chova",
  ...
  "southern grey shrike": "Alcaudón meridional",
  "stonechat": "Tarabilla",
  ...
  "turtle dove": "Tórtola europea",
  "stock dove": "Paloma zurita",
  "pigeon": "Paloma",
  "dove": "Tórtola",
  "cuckoo": "Cuco",
  ...
  "pratincole": "Canastera",
  "cream-colored courser": "Corredor sahariano",

  // Reptiles
  "terrapin": "Galápago",
  "box turtle": "Tortuga",
  "mud turtle": "Galápago",
  "pond turtle": "Galápago",
  "painted turtle": "Galápago",
  ...
  "sand lizard": "Lagartija",
  "wall lizard": "Lagartija",
  ...
  "skink": "Eslizón",
  "slow worm": "Lución",
  "worm lizard": "Culebrilla",
  "amphisbaena": "Culebrilla",
  ...
  "common frog": "Rana común",
  "green frog": "Rana verde",
  "edible frog": "Rana verde",
  "marsh frog": "Rana de Pérez",
  "painted frog": "Sapillo pintojo",
  ...
  "newt": "Tritón",
  "alpine newt": "Tritón alpino",
  "palmate newt": "Tritón palmeado",
  ...
  "four-toed hedgehog": "Erizo moruno",
  "porcupine": "Puercoespín",
  "mole": "Topo",
  "european mole": "Topo común",
  "shrew": "Musaraña",
  "water shrew": "Musaraña acuática",
  "bat": "Murciélago",
  "horseshoe bat": "Murciélago de herradura",
  "pipistrelle": "Murciélago",
  "noctule": "Nóctulo",
  "serotine": "Murciélago",
  ...
  "yellow-necked mouse": "Ratón leonado",
  "harvest mouse": "Ratón espiguero",
  "mouse": "Ratón",
  "rat": "Rata",
  ...
  "bee": "Abeja",
  "wasp": "Avispa",
  "yellow jacket": "Avispa",
  "hornet": "Avispón",
  "asian giant hornet": "Avispa asiática",
  "ant": "Hormiga",
  "mantis": "Mantis",
...
function traducirEspecie(nombreIngles) {
  const nombre = nombreIngles.toLowerCase().trim();
  
  // 1. Búsqueda exacta (máxima prioridad)
  if (diccionarioEspecies[nombre]) {
    return diccionarioEspecies[nombre];
  }
  
  // 2. Búsqueda por palabras completas (evita el bug de "albatross" -> "bat")
  const palabras = nombre.split(/[\s-]+/);
  for (const [clave, valor] of Object.entries(diccionarioEspecies)) {
    const clavePalabras = clave.split(/[\s-]+/);
    // Solo hacer match si TODAS las palabras de la clave están en el nombre
    const todasCoinciden = clavePalabras.every(cp => palabras.includes(cp));
    if (todasCoinciden && clavePalabras.length > 1) {
      return valor;
    }
  }
  
  // 3. Búsqueda por palabra suelta (solo para claves de 1 palabra, con límite de longitud mínimo)
  for (const [clave, valor] of Object.entries(diccionarioEspecies)) {
    if (!clave.includes(' ') && clave.length >= 4) {
  ...
  // 4. No encontrado: devolver el nombre original en inglés
  return null;
}
...
async function cargarModeloIA() {
  ...
  modeloCargando = true;
  console.log("🧠 Cargando modelo de Inteligencia Artificial...");
  try {
    modeloIA = await mobilenet.load({ version: 2, alpha: 1.0 });
...
async function analizarImagenLocal(imagenBase64) {
  const modelo = await cargarModeloIA();
  if (!modelo) return [];

  const resultadoDiv = document.getElementById('resultadoIdentificacion');
  if (resultadoDiv) {
    resultadoDiv.innerHTML = '<p style="text-align: center; padding: 15px; color: #4c8c6a; font-weight: bold;">🧠 La Inteligencia Artificial está analizando la imagen...</p>';
  }
...
async function procesarFoto(input) {
  ...
  if (resultadoDiv) {
    ...
    resultadoDiv.innerHTML = '<p style="text-align: center; padding: 15px; color: #4c8c6a; font-weight: bold;">📸 Preparando imagen...</p>';
  }

  const reader = new FileReader();
  reader.onload = async function(e) {
    const base64 = e.target.result;
    const resultados = await analizarImagenLocal(base64);
...
const pantallas = {
  ...
  identificacion: {
    tipo: "resultado",
    titulo: "📷 Identificación por Inteligencia Artificial",
    contenido: `
      <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
        <p style="margin: 0; color: #166534; font-weight: 600; font-size: 15px;">
          🤖 Sube la foto. Nuestra IA la analizará localmente en tu dispositivo para sugerirte la especie.
        </p>
      </div>
      ...
      <div style="margin: 20px 0;">
        ...
        <button class="btn btn-primary" onclick="document.getElementById('fotoIdentificacion').click()"
                style="width: 100%; padding: 18px; font-size: 16px; margin-bottom: 10px; display: flex; align-items: center; justify-content: center; gap: 10px;">
           Subir o tomar foto para identificar
        </button>
      </div>
      ...
      <h3 style="font-size: 16px; color: #1e293b;">¿La IA no lo tiene claro o es una especie muy rara?</h3>
