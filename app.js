...
const pantallas = {
 ...
 panal: {
  ...
  cerdoVietnamitaNoRetenido: {
    ...
    contenido: `<h3>No cazamos animales.</h3><p>Si no pueden retenerlo, puededn contactar con el 112.</p><div class="contact-box"><strong> WhatsApp: 686 680 254</strong></div>`
  }
